...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        print("Using default path. To specify a video, run:")
        print("  python test_single_video.py /path/to/your/video.mp4")
        print()
    ...
    if not video_path.exists():
        ...
        print("Please provide a valid media file path.")
        sys.exit(1)
    ...
    if srt_path.exists():
        ...
        print("Delete it first to regenerate, or test with a different video.")
        sys.exit(0)
