...
"""
    ...
    def test_show_name_extraction(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            for video_path_str, expected_name in test_cases:
                ...
                test_keyterms = ["test"]
                save_keyterms_to_csv(video_path, test_keyterms)
    ...
    def test_unicode_support(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Unicode keyterms
            unicode_keyterms = ["François", "Müller", "北京", "日本語", "Ñoño", "Café"]
    ...
    def test_api_parameter_format(self):
        ...
        with patch("core.transcribe.DeepgramClient") as mock_client:
            ...
            try:
                ...
                transcribe_file(audio_data, "fake_api_key", "nova-3", "en", keyterms=test_keyterms)
